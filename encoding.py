	...
	for model_iter in range(len(audio_model)):
		...
		for iter in range(len(songs)):
			try:
				...
				file_path = args.feature_path + D7id_to_path[Tid_to_D7id[Sid_to_Tid[songs[iter].decode('UTF-8')]]].replace('.mp3','.npy')
...
if __name__ == '__main__':	
	...
	parser.add_argument('--weight_name', type=str,default='/Users/ECHO/Documents/songtest/deep-content-user-master/models/model_basic_20_0.20/weights.01-40.01.h5', help='weight path')
	...
	parser.add_argument('--num-user', type=int, default=2000, help='the number of users')
	parser.add_argument('--num-song', type=int, default=1000, help='the number of items')
